...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-08-2025 a las 15:33:29
...
(53, 'MODULO DE FIORELLA', 1, 'P/P-NUEVO-30.php', NULL);
...
(61, 156, 'andrea', '202cb962ac59075b964b07152d234b70', 1);
...
--
ALTER TABLE `area`
  MODIFY `id_area` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT de la tabla `bien`
--
ALTER TABLE `bien`
  MODIFY `id_bien` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=268;
...
--
ALTER TABLE `detallemovimiento`
  MODIFY `id_detallemovimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=303;

--
-- AUTO_INCREMENT de la tabla `historial_movimiento`
--
ALTER TABLE `historial_movimiento`
  MODIFY `id_movimiento_historial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `movimiento`
  MODIFY `id_movimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
...
--
ALTER TABLE `persona`
  MODIFY `id_persona` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=157;
...
--
ALTER TABLE `usuario_menu`
  MODIFY `id_usuariomenu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
