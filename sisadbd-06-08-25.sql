...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-08-2025 a las 09:32:45
...
CREATE TABLE `detallemovimiento` (
  ...
  `estado_detalle_movimiento` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `historial_movimiento`
  MODIFY `id_movimiento_historial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
