<?php
// ===== ln_editar_equipo.php CORREGIDO =====
...
try {
    ...
    $id_ubicacion_equipos = intval($_POST['id_ubicacion_equipos'] ?? 0);
    ...
    $resultado = editarUbicacionEquipo(
        $id_ubicacion_equipos,
        $ip,
        $mac,
    ...
    error_log("Error en ln_editar_equipo.php: " . $e->getMessage());
    echo json_encode([
        'success' => false,
