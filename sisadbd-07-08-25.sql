...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-08-2025 a las 06:26:55
...
(261, 4, 'DELL', 'DELL 300', 'I8', 'NOSE', 'NOSE', '1', '2025', 'OC-2025', 'NINGUNA', 700000, 1),
...
(267, 14, 'NOSE', 'NOSE', 'NOSE', 'NOSE', 'NOSE', '2', '25', 'NOSE', 'NOSE', 800, 1);
...
--
ALTER TABLE `detallemovimiento`
  MODIFY `id_detallemovimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=299;

--
-- AUTO_INCREMENT de la tabla `historial_movimiento`
--
ALTER TABLE `historial_movimiento`
  MODIFY `id_movimiento_historial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
