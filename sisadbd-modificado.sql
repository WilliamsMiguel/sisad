...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-07-2025 a las 18:15:36
...
INSERT INTO `usuario_menu` (`id_usuario`, `id_menu`) VALUES
(56, 3);
...
ALTER TABLE `usuario_menu`
  ADD PRIMARY KEY (`id_usuario`,`id_menu`),
...
--
ALTER TABLE `log_acciones`
  MODIFY `id_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=559;
...
--
ALTER TABLE `usuario_menu`
  ADD CONSTRAINT `usuario_menu_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`),
  ADD CONSTRAINT `usuario_menu_ibfk_2` FOREIGN KEY (`id_menu`) REFERENCES `menu` (`id_menu`);
COMMIT;
